...
# Double check for NaNs and fill any remaining
print("Checking for remaining NaNs in Train:")
print(train_processed.isnull().sum())
train_processed = train_processed.fillna(train_processed.mean())
train_processed = train_processed.fillna(0) # Final fallback

print("Checking for remaining NaNs in Test:")
print(test_processed.isnull().sum())
test_processed = test_processed.fillna(test_processed.mean())
test_processed = test_processed.fillna(0) # Final fallback
